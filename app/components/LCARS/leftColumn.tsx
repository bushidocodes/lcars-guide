...
export default () => (
  <div className="lcars-column u-1-8" style={{ width: 50 }}>
    <ul className="lcars-menu left">
      ...
      <li className="lcars-blue-bg tall">
        <NavLink to="/seasons/2">
          <span className="right" style={{ fontSize: 24 }}>
            II
          </span>
        </NavLink>
      </li>
      <li className="lcars-blue-bg tall">
        <NavLink to="/seasons/3">
          <span className="right" style={{ fontSize: 24 }}>
            III
          </span>
        </NavLink>
